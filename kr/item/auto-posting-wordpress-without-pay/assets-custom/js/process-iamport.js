...
function pay() {
  ...
  IMP.request_pay({
    ...
    if ( rsp.success ) {
      ...
      jQuery.ajax({
        url: "https://www.wp-kr.com/item/auto-posting-wordpress/process-after-payment-success.php",
        ...
        jQuery.ajax({
          url: "https://www.wp-kr.com/item/auto-posting-wordpress/process-after-payment-failure.php",
